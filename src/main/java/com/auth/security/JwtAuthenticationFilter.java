...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (requestHeader != null && requestHeader.contains("Bearer")) {
			...
			logger.info("Inavlid token found!");
		}
		// checks if the username isn't null and the user is not already authenticated
		...
		// passes control to the next filter in the chain or the controller or end-point
